        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="customFile">Telechager une image</label>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group d-flex justify-content-center rounded-circle">
                <img src="assets/uploads/<?php echo $_SESSION['login_profile_pic'] ?>" alt="" id="profile"
                    class="img-fluid img-thumbnail rounded-circle" style="max-width: calc(50%)">
            </div>
        </div>
