        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <input type="text" class="form-control" placeholder="Nom" name='firstname'
                        value="<?php echo $_SESSION['login_firstname'] ?>">
                </div>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control" placeholder="Post nom" name='lastname'
                        value="<?php echo $_SESSION['login_lastname'] ?>">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <small><i>Remplissez ces cases si vous voulez changer le mot de passe</i></small>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-12">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    <select name="month" id="month" class="custom-select">
                        ...
                        <option value="<?php echo $i ?>"
                            <?php echo $i == abs(date("m", strtotime($_SESSION['login_dob']))) ? "selected" : '' ?>>
                ...
                <div class="form-group col-md-4">
                    <select name="day" id="day" class="custom-select">
						...
						?>
                        <option value="<?php echo $i ?>"
                            <?php echo $i == abs(date("d", strtotime($_SESSION['login_dob']))) ? "selected" : '' ?>>
                            <?php echo $i ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div class="form-group col-md-4">
                    <select name="year" id="year" class="custom-select">
						...
						?>
                        <option value="<?php echo $i ?>" <?php echo $i == abs(date("Y")) ? "selected" : '' ?>>
                            <?php echo $i ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                    ...
                    <div class="d-flex w-100 justify-content-between p-1 border rounded align-items center">
                        ...
                        <div class="form-check d-flex w-100 justify-content-end">
                            <input class="form-check-input" type="radio" checked="" id="gfemale" name="gender"
                                value="Female" <?php echo $_SESSION['login_gender'] == "Female" ? "checked" : '' ?>>
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <div class="d-flex w-100 justify-content-between p-1 border rounded align-items center">
                        ...
                        <div class="form-check d-flex w-100 justify-content-end">
                            <input class="form-check-input" type="radio" id="gmale" name="gender" value="Male"
                                <?php echo $_SESSION['login_gender'] == "Male" ? "checked" : '' ?>>
                        </div>
                    </div>
                </div>
            </div>
    ...
    if (cpass == '' || pass == '') {
        ...
        if (cpass == pass) {
            ...
            $('#pass_match').attr('data-status', '2').html(
                '<i class="text-danger">Les 2 mot de passe ne concoredent pas.</i>')
        }
    }
})
