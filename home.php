...
<div class="d-flex w-100 h-100">
    <div class="left-panel mt-1">
        <a href="index.php?page=profile" class="d-flex py-2 px-1 text-dark side-nav rounded">
            ...
            <?php endif; ?>
            <span
                class="ml-3"><b><?php echo ucwords($_SESSION['login_firstname'] . ' ' . $_SESSION['login_lastname']) ?></b></span>
        </a>
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="d-flex w-100">
                                ...
                                <button class="btn btn-default ml-4 text-left" id="write_post" type="button"
                                    style="width:calc(80%);border-radius: 50px !important;"><span>Que voulez-vous dire,
                                        <?php echo ucwords($_SESSION['login_firstname']) ?>?</span></button>
                            </div>
                            <hr>
                            <div class="d-flex w-100 justify-content-center">
                                <a href="javascript:void(0)" id="upload_post" class="text-dark post-link px-3 py-1"
                                    style="border-radius: 50px !important;"><span
                                        class="fa fa-photo-video text-success"></span> Photo/Video</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
                            ...
                            <figure class="gallery__item position-relative" style="<?php echo $style ?>">
                                ...
                                <div class="position-absolute d-flex justify-content-center align-items-center h-100 w-100"
                                    ...
                                    <a href="javascript:void(0)" class="text-white view_more"
                                        ...
                                        <h4 class="text-white text-center"><?php echo '+ ' . ($count - 4) ?> Plus</h4>
                                    </a>
                                </div>
                                <?php endif; ?>
                                ...
                                <a href="assets/uploads/<?php echo $row['id'] . '/' . $v ?>" class="lightbox-items"
                                    ...
                                    <img src="assets/uploads/<?php echo $row['id'] . '/' . $v ?>" class="gallery__img"
                                        alt="Image 1">
                                </a>
                                <?php else : ?>
                                <?php if ($count > 1) : ?>
                    ...
                    <div class="card-footer">
                        <form action="#" method="post">
                            ...
                            <div class="img-push">
                                <textarea cols="30" rows="1" class="form-control comment-textfield" style="resize:none"
                                    placeholder="Cliquer sur entrer pour commenter"
