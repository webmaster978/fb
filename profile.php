    ...
    <div class="container">
        <div class="col-lg-10 offset-md-1" style="height:60vh">
            <div class="position-relative image-fluid w-100 mb-1" style="height:65%">
                <img src="assets/uploads/<?php echo $_SESSION['login_cover_pic'] ?>" alt=""
                    class="gallery__image cover-pic img-fluid rounded-bottom">
                <div class="position-absolute" style="top:85%;right:3%;z-index:1">
                    <button class="btn btn-dark btn-sm bg-dark" type="button" id="edit_cover"><i
                            class="fa fa-camera"></i> Changer la photo de couverture</button>
                </div>
                <div class="w-100 d-flex justify-content-center position-absolute" style="top:50%">
                    <span class="position-relative">
                        <img src="assets/uploads/<?php echo $_SESSION['login_profile_pic'] ?>" alt=""
                            class="img-fluid img-thumbnail rounded-circle" style="width:150px;height: 150px">
                        <a href="javascript:void(0)" id="edit_pp"
                            class="text-dark position-absolute rounded-circle img-thumbnail d-flex justify-content-center align-items-center"
                            style="top:75%;left:75%;width:25px;height: 25px"><i
                                class="fa fa-camera rounded-circle"></i></a>
                    </span>
                </div>
            </div>
            <div class="d-block w-100 py-2 px-1 text-center">
                <h2 class="text-dark text-center">
                    <b><?php echo ucwords($_SESSION['login_firstname'] . ' ' . $_SESSION['login_lastname']); ?></b>
                </h2>
            ...
            <div class="col-md-4">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <strong><i class="fas fa-calendar-day mr-1"></i> Date d'anniverssaire</strong>

                        <p class="text-muted"><?php echo $_SESSION['login_dob'] ?></p>
                    ...
                    <div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
                        <div class="card-header">
                            <div class="user-block">
                                <img class="img-circle" src="assets/uploads/<?php echo $row['profile_pic'] ?>"
                                    alt="User Image">
                                <span class="username"><a href="#"><?php echo $row['name'] ?></a></span>
                                <span class="description">Posted -
                                    <?php echo date("M d,Y h:i a", strtotime($row['date_created'])) ?></span>
                            </div>
                            <!-- /.user-block -->
                            <div class="card-tools">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item edit_post" data-id="<?php echo $row['id'] ?>"
                                            href="javascript:void(0)">Modifier</a>
                                        <a class="dropdown-item delete_post" data-id="<?php echo $row['id'] ?>"
                        ...
                        <div class="card-body">
                            ...
                            <a href="javascript:void(0)" class="d-none show-content">Voir plus</a>
                            ...
                            <div class="gallery mb-2">
                                ...
                                <figure class="gallery__item position-relative" style="<?php echo $style ?>">
                                    ...
                                    <div class="position-absolute d-flex justify-content-center align-items-center h-100 w-100"
                                        ...
                                        <a href="javascript:void(0)" class="text-white view_more"
                                            data-id="<?php echo $row['id'] ?>">
                                            <h4 class="text-white text-center"><?php echo '+ ' . ($count - 4) ?> More
                                            </h4>
                                        </a>
                                    </div>
                                    <?php endif; ?>
                                    <?php if (strstr($mime, 'image')) : ?>
                                    <a href="assets/uploads/<?php echo $row['id'] . '/' . $v ?>" class="lightbox-items"
                                        data-toggle="lightbox<?php echo $row['id'] ?>" data-slide="<?php echo $k ?>"
                                        data-title="" data-gallery="gallery" data-id="<?php echo $row['id'] ?>">
                                        <img src="assets/uploads/<?php echo $row['id'] . '/' . $v ?>"
                                    ...
                                    <a href="assets/uploads/<?php echo $row['id'] . '/' . $v ?>" class="lightbox-items"
                                        ...
                                        <video <?php echo $count == 1 ? "controls" : '' ?> class="gallery__img">
                                            <source src="assets/uploads/<?php echo $row['id'] . '/' . $v ?>"
                                                type="<?php echo $mime ?>">
                                        </video>
                                        <?php if ($count > 1) : ?>
                                    </a>
                                    <a href="javascript:void(0)" class="text-white view_more"
                                        ...
                                        <div class="position-absolute d-flex justify-content-center align-items-center h-100 w-100"
                                            style="top:0;left:0;z-index:1">
                                            <h3 class="text-white text-center rounded-circle "><i
                                                    class="fa fa-play-circle "></i></h3>
                                        </div>
                                    </a>
                                    <?php endif; ?>
                            ...
                            <button type="button" class="btn btn-default btn-sm like <?php echo $is_liked ?>"
                                data-id="<?php echo $row['id'] ?>"><i class="far fa-thumbs-up"></i> Like</button>
                            <span class="float-right text-muted counts"><span
                                    class="like-count"><?php echo number_format($liked) ?></span>
                                <?php echo $liked > 1 ? "likes" : "like" ?> - <span
                                    class="comment-count"><?php echo number_format($commented) ?></span> comments</span>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer card-comments">
                            ...
                            <div class="card-comment">
                                <!-- User image -->
                                <img class="img-circle img-sm" src="assets/uploads/<?php echo $crow['profile_pic'] ?>"
                                    alt="User Image">
                                ...
                                <div class="comment-text">
                                    <span class="username">
                                        ...
                                        <span
                                            class="text-muted float-right timestamp"><?php echo date("M d,Y h:i A", strtotime($crow['date_created'])) ?></span>
                                    </span><!-- /.username -->
                                    <span class="comment">
                        ...
                        <div class="card-footer">
                            <form action="#" method="post">
                                ...
                                <div class="img-push">
                                    <textarea cols="30" rows="1" class="form-control comment-textfield"
                                        style="resize:none" placeholder="Press enter to post comment"
                                        data-id="<?php echo $row['id'] ?>"></textarea>
                                </div>
                            </form>
                        </div>
                        <!-- /.card-footer -->
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 1) {
                        ...
                        cfield.find('.img-circle').attr('src', 'assets/uploads/' + resp.data
                            .profile_pic)
                        ...
                        $('.post-card[data-id="' + post_id + '"]').find('.card-comments').append(
                            cfield)
                        var cc = $('.post-card[data-id="' + post_id + '"]').find('.comment-count')
                            .text();
                        cc = cc.replace(/,/g, '');
                        cc = parseInt(cc) + 1
