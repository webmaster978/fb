    ...
    <form action="" id="manage_post">
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="ml-4 text-left" style="width:calc(80%)">
                <div>
                    <small><?php echo ucwords($_SESSION['login_firstname']) . ' ' . $_SESSION['login_lastname'] ?></small>
                </div>
                <input type="hidden" name="type" value="<?php echo isset($type) ? $type : 0 ?>">
                <div class="dropdown">
                    <a href="javascript:void(0)" class="badge badge-pill badge-secondary text-white dropdown-toggle "
                        id="type-selected" data-toggle="dropdown">
                        <?php if (isset($type) && $type == 1) : ?>
                        <i class="fa fa-lock"></i> Moi uniquement
                        <?php else : ?>
                        <i class="fa fa-globe-asia"></i> Public
                        <?php endif; ?>
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item type-item" href="javascript:void(0)" data-type="0"><i
                                class="fa fa-globe-asia"></i> Public</a>
                        <a class="dropdown-item type-item" href="javascript:void(0)" data-type="1"><i
                                class="fa fa-lock"></i> Moi uniquement</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group">
            <textarea name="content" id="content" cols="30" rows="2" class="form-control"
                placeholder="Que voulez-vous dire?, <?php echo ucwords($_SESSION['login_firstname']) ?>?"
                style="resize:none;border: none"><?php echo isset($content) ? $content : '' ?></textarea>
        </div>
        <div class="c-row" id="">
            <div id="file-display" class="column">
				...
				?>
                <div class="imgF">
                    <span class="rem badge badge-primary" onclick="rem_func($(this))" style="cursor: pointer;"><i
        ...
        <input type="file" name="file[]" multiple="multiple" onchange="" id="postF" onchange="displayUpload(this)"
            class="d-none" accept="image/*,video/*">
        <div class="card solid">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <small>Ajouter à votre Post</small>
                    <span>
                        <label for="postF" style="cursor: pointer;"><a class="rounded-circle"><i
                                    class="fa fa-photo-video text-success"></i></a></label>
                    </span>
                </div>
            </div>
        </div>
...
<div class="modal-footer display py-1 px-1">
    <div class="d-block w-100">
        <button class="btn btn-block btn-primary btn-sm" form="manage_post">Publier</button>
    </div>
</div>
