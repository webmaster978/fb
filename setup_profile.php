            ...
            <div class="card" style="width:50rem">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" name="pp"
                                            accept="image/*" onchange="displayImgProfile(this,$(this))">
                                        <label class="custom-file-label" for="customFile">Telecharger une image</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" name="cover"
                                            accept="image/*" onchange="displayImgCover(this,$(this))">
                                        <label class="custom-file-label" for="customFile">Telecharger une image</label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-footer">
                    <div class="d-flex w-100 justify-content-end">
                        <button class="btn btn btn-primary align-self-end" form="additional-info">Modifier</button>
                    </div>
                </div>
            </div>
        </div>
